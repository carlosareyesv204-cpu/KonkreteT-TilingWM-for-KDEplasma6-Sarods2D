...
1.  Download the `KoncreteT.kwinscript` file from the [Releases](https://github.com/carlosareyesv204-cpu/KonkreteT-TilingWM-for-KDEplasma6-Sarods2D/releases) section.
